...
def publish_data():
    ...
    motion_duration=accel()
    print(f"Motion Duration: {motion_duration} sec")
    ...
    # Every 1 minute
    if current_time - start_minute_time >= 60 and (total_motion_duration < 45 or total_motion_duration) > 55:
        motion_alert = "Warning: Motion duration outside of expected range!"
        print(f"\033[1;31m{spo2_alert}\033[0m")
